...
<!--                </div>-->
                ...
                <div class="form-group">
                    <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Hostname</label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input value="<?php show_ifset($data->hostname);?>"
                               class="form-control col-md-7 col-xs-12"
                               type="text" name="hostname" required>
                    </div>
                </div>
                <div class="form-group">
                    <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Versi</label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input value="<?php show_ifset($data->versi);?>"
                               class="form-control col-md-7 col-xs-12"
                               type="text" name="versi" required>
                    </div>
                </div>
